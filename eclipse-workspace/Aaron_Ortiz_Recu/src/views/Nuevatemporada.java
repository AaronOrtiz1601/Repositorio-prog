      ...
      getContentPane().add(buttonPane, BorderLayout.SOUTH);
      {
        ...
        okButton.addActionListener(new ActionListener() {
          public void actionPerformed(ActionEvent e) {
            ...
            int numero2 = Integer.parseInt(textField.getText());
            Temporada nuevaTemporada = new Temporada(numero2,dateChooserIni.getDate() , dateChooserFin.getDate(),numero );
            for (Serie nuevaSerie : App.series) {
              if (textFieldNombre.getText().equals(nuevaSerie.getNombre())) {
                List<Temporada> temporada = nuevaSerie.getLstTemporadas();
            ...
            JOptionPane.showMessageDialog(null, "Temporada creada con exito", "Exito", JOptionPane.INFORMATION_MESSAGE);
