  ...
  public SesionEntrenador() {
    ...
    lblNewLabel_2.addMouseListener(new MouseAdapter() {
      ...
      public void mouseClicked(MouseEvent e) {
        if(Principal.getEntrenadorActivo().getEquipo() == "")
        {
          cambiarPanel(new SinEquipo(layeredPane));
        }else {
          cambiarPanel(new ConEquipoEntrenador(layeredPane));
        }
    ...
    lblNewLabel_7.setIcon(new ImageIcon(SesionEntrenador.class.getResource("/resources/Jugadores.png")));
